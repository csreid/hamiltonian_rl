"""DHGN-LSTM experiment on synthetic damped-SHO image sequences."""
...
class DHGNLSTMExperiment(Experiment):
	def tb_comment(self) -> str:
		return "_dhgn_lstm_sho_images"

	def build_model(self, cfg: ExperimentConfig) -> DHGN_LSTM:
		return DHGN_LSTM(
